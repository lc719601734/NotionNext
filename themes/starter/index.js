...
export function filterStarterBlogPosts(posts = [], config = CONFIG) {
  const includeCategories = normalizeStarterBlogFilterList(
    config?.STARTER_BLOG_INCLUDE_CATEGORIES ?? starterConfig('STARTER_BLOG_INCLUDE_CATEGORIES', [])
  )
  const excludeCategories = normalizeStarterBlogFilterList(
    config?.STARTER_BLOG_EXCLUDE_CATEGORIES ?? starterConfig('STARTER_BLOG_EXCLUDE_CATEGORIES', [])
  )
  const includeTags = normalizeStarterBlogFilterList(
    config?.STARTER_BLOG_INCLUDE_TAGS ?? starterConfig('STARTER_BLOG_INCLUDE_TAGS', [])
  )
  const excludeTags = normalizeStarterBlogFilterList(
    config?.STARTER_BLOG_EXCLUDE_TAGS ?? starterConfig('STARTER_BLOG_EXCLUDE_TAGS', [])
  )
