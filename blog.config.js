...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '02ab3b8678004aa69e9e415905ef32a5,en:3040d6794d898016b32adaca83dc91c0',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'PaisoTech', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Hydrogen Compressor and Refueling🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.paisotech.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Hydrogen Compressor,Hydrogen Refueling', // 网站关键词 英文逗号隔开
